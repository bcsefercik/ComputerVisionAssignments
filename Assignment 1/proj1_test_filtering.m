...
%% Setup
test_image = im2single(imread('part_one_images/wallpaper.jpg'));
test_image = imresize(test_image, 0.2, 'bilinear'); %resizing to speed up testing
figure(1)
imshow(test_image)
...
imwrite(identity_image, 'part_one_images/identity_image.jpg', 'quality', 95);
...
imwrite(blur_image, 'part_one_images/blur_image.jpg', 'quality', 95);
...
imwrite(large_blur_image, 'part_one_images/large_blur_image.jpg', 'quality', 95);
...
imwrite(sobel_image + 0.5, 'part_one_images/sobel_image.jpg', 'quality', 95);
...
imwrite(laplacian_image + 0.5, 'part_one_images/laplacian_image.jpg', 'quality', 95);

%% High pass "filter" alternative
high_pass_image = test_image - blur_image; %simply subtract the low frequency content

figure(7); imshow(high_pass_image + 0.5);
imwrite(high_pass_image + 0.5, 'part_one_images/high_pass_image.jpg', 'quality', 95);
