...
image1 = im2single(imread('part_two_images/submarine.bmp'));
image2 = im2single(imread('part_two_images/fish.bmp'));
...
figure(3); imshow(vis);
imwrite(low_frequencies, 'part_two_images/low_frequencies.jpg', 'quality', 95);
imwrite(high_frequencies + 0.5, 'part_two_images/high_frequencies.jpg', 'quality', 95);
imwrite(hybrid_image, 'part_two_images/hybrid_image.jpg', 'quality', 95);
imwrite(vis, 'part_two_images/hybrid_image_scales.jpg', 'quality', 95);